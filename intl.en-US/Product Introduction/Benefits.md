...
-   If you want to use Alibaba Cloud CDN to process a large number of workloads, contact Alibaba Cloud Customer Service.
...
-   You can integrate Alibaba Cloud CDN with other Alibaba Cloud services to optimize service performance and improve management efficiency.
    ...
    |----------------|-------------------|-------|
    |[Elastic Compute Service \(ECS\)](/intl.en-US/Product Introduction/What is ECS?.md)|Alibaba Cloud CDN|If you use an ECS instance as an origin server, you can use Alibaba Cloud CDN to accelerate the website that is deployed on the ECS instance.|
    |[Object Storage Service \(OSS\)](/intl.en-US/Product Introduction/What is OSS?.md)|If you use an OSS bucket as an origin server, you can use Alibaba Cloud CDN to accelerate content delivery and reduce data transfer fees.|
...
-   Quick-response troubleshooting systems:
    ...
    -   Ticket system: To request technical support, you can also [submit a ticket](https://workorder-intl.console.aliyun.com/?spm=5176.2020520001.aliyun_topbar.18.dbd44bd3e4f845#/ticket/createIndex).
...
2.  Log on to the [Alibaba Cloud CDN console](https://www.alibabacloud.com/zh/product/cdn) and select a metering method based on your business requirements. For more information, see [Recommended metering methods and resource plans](#section_2k3_p0x_sci).
...
|--------|--------------------------------------------|
|A small amount of the bandwidth capacity but a large amount of network traffic is consumed by requests that are redirected to origin servers.|Pay-by-bandwidth**Note:** To change to the pay-by-bandwidth metering method, [submit a ticket](https://workorder-intl.console.aliyun.com/?spm=5176.2020520001.aliyun_topbar.18.dbd44bd3e4f845#/ticket/createIndex) or contact your sales manager. |
...
For more information about the metering methods of Alibaba Cloud CDN, see [CDN Pricing](https://www.alibabacloud.com/product/cdn/pricing). You can also use the price calculator to estimate your expenses. You can click [here](https://www.alibabacloud.com/product/cdn/pricing) to purchase Alibaba Cloud CDN.
