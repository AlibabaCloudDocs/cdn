...
## 调试 {#section_3mp_87y_mlk .section}

前往【[API Explorer](https://api.aliyun.com/#/?product=Cdn&api=DescribeDomainRealTimeHttpCodeData)】在线调试，API Explorer提供在线调用API、动态生成SDK Example代码和快速检索接口等能力，能显著降低使用云API的难度，强烈推荐使用。

## 请求参数 {#section_mrx_84d_ldt .section}
...
## 返回参数 {#section_jnj_vpr_xxl .section}
...
## 示例 {#section_b71_xyd_003 .section}

请求示例

``` {#codeblock_y7z_okw_neb}
...
``` {#codeblock_kgu_yhu_tkq .language-json}
{
...
## 错误码 {#section_xsb_yc9_id8 .section}
