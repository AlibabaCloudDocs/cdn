...
[您可以在OpenAPI Explorer中直接运行该接口，免去您计算签名的困扰。运行成功后，OpenAPI Explorer可以自动生成SDK代码示例。](https://api.aliyun.com/#product=Cdn&api=DescribeDomainFileSizeProportionData&type=RPC&version=2014-11-11)
...
<DescribeDomainFileSizeProportionDataResponse>
	  ...
	  <StartTime>2015-11-30T01:33:00Z</StartTime>
</DescribeDomainFileSizeProportionDataResponse>
```
