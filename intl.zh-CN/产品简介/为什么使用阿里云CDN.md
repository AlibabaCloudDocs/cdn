...
阿里云CDN支持多种行业、多种场景内容加速，例如：图片小文件、大文件下载、视音频点播、直播流媒体、全站加速、安全加速，并为您提供易用性的功能配置和脚本服务。已经成功接入阿里云CDN并实现业务加速的案例，请参见[客户案例](/intl.zh-CN/产品简介/客户案例.md)、[阿里云护航亚航季度大促顺利进行](/intl.zh-CN/行业案例/阿里云护航亚航季度大促顺利进行.md)。
