...
了解CDN的RAM用户如何使用，请参见[CDN子账户使用指南](/intl.zh-CN/服务管理/RAM用户权限管理/CDN子账户使用指南.md)。

了解通过RAM为CDN创建自定义授权策略，请参见[通过RAM对CDN进行权限管理](/intl.zh-CN/教程/通过RAM对CDN进行权限管理.md)。

了解如何通过RAM为RAM用户授予刷新预热功能的权限，请参见[授予RAM用户刷新预热权限](/intl.zh-CN/服务管理/RAM用户权限管理/授予RAM用户刷新预热权限.md)。
