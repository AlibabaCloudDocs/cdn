...
-   **video**：视音频点播。
-   **liveStream**：直播流媒体。 |
|DomainName|String|是|.a.com|需要接入CDN的域名。支持泛域名，以点号（.）开头。 |
...
|SourceType|String|否|domain|源站类型。
...
|400|ExtensiveAndSpecificDomainConflict|Extensive domain and corresponding specific domain are mutually exclusive.|泛域名和同级精确域名互斥，请重新添加。了解更多可参见<a href="https://help.aliyun.com/knowledge\_detail/40103.html" target="\_blank"\>泛域名加速规则</a\>。|
